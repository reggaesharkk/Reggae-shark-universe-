> Universe mirror of [the canonical specialist note](https://github.com/reggaesharkk/navier-stokes-bridge-audit/blob/9caa90e3defb5e64efbe132a45623a24902b3ba0/notes/WP16_036_N12_FROZEN_K36_HOLDOUT_RESULT_2026_09_26.md), with source links adapted to the specialist repository. The frozen source and raw data live there.
...
The source coalition consists of the first 36 ordered source-orbit groups ranked by absolute contribution to the N11 target-only k-channel. The precise ordered keys, in their frozen order, are in [`frozen_K36_ordered_source_orbits.json`](https://github.com/reggaesharkk/navier-stokes-bridge-audit/blob/9caa90e3defb5e64efbe132a45623a24902b3ba0/results/wp16_n12_holdout/frozen_K36_ordered_source_orbits.json). The original ranking input is archived in compressed form, with its uncompressed SHA-256 in the checksum file.
...
All required raw files are in [`results/wp16_n12_holdout/`](https://github.com/reggaesharkk/navier-stokes-bridge-audit/tree/9caa90e3defb5e64efbe132a45623a24902b3ba0/results/wp16_n12_holdout/), with SHA-256 hashes in [`SHA256SUMS.txt`](https://github.com/reggaesharkk/navier-stokes-bridge-audit/blob/9caa90e3defb5e64efbe132a45623a24902b3ba0/results/wp16_n12_holdout/SHA256SUMS.txt). The ranking input is gzip-compressed to keep the repository compact. To rerun the exact evaluator, decompress it to `wp16_036_phase_velocity_rhs_sources.json`, then run:
